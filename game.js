...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Physics constants
    const GRAVITY = 0.5;
    const JUMP_ACCELERATION = -1.2;
    const MIN_JUMP_VELOCITY = -15;
    const MOVE_SPEED = 15;
